...
(function () {
  ...
  const dict = {
    ...
    en: {
      ...
      'admin.noMessagesSub': 'Contact form submissions will appear here.',
      ...
      'admin.itemCategory': 'Category',
      'admin.itemPrice': 'Price',
      'admin.itemDesc': 'Short description',
      'admin.itemImage': 'Image URL (optional)',
      'admin.addItemBtn': 'Add item',
      'admin.itemRequired': 'Enter a name and a valid price (0–99).',
      'admin.itemAdded': 'Item added — it is now live on the customer menu.',
      'admin.addItemError': 'Could not add the item. Is the admin session active?',
      /* admin login */
    ...
    tr: {
      ...
      'admin.noMessages': 'Henuz mesaj yok',
      'admin.noMessagesSub': 'Iletisim formu gonderimleri burada gorunecek.',
      'admin.markRead': 'Okundu isaretle',
      ...
      'admin.addItem': 'Urun Ekle',
      'admin.itemName': 'Urun adi',
      'admin.itemCategory': 'Kategori',
      'admin.itemPrice': 'Fiyat',
      'admin.itemDesc': 'Kisa aciklama',
      'admin.itemImage': 'Gorsel URL (istege bagli)',
      'admin.addItemBtn': 'Urun Ekle',
      'admin.itemRequired': 'Bir isim ve gecerli bir fiyat girin (0-99).',
      'admin.itemAdded': 'Urun eklendi — musteri menuden gorunuyor.',
      'admin.addItemError': 'Urun eklenemedi. Yonetici oturumu aktif mi?',
      /* admin login */
